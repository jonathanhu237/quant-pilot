...
export const STRATEGY_DETAIL_ROUTE_PATTERN = '/(tabs)/strategy/[id]' as const;
...
export function getStrategyDetailRoute(id: string) {
  return {
    params: { id },
    pathname: STRATEGY_DETAIL_ROUTE_PATTERN,
  } as const;
}
